...
graph TD
    ...
    WRTC_R -->|Decoded Frames| FFI
    FFI -->|Shared Buffer / Pointers| WMF_DLL
...
- **Virtual Camera Bridge**: High-performance Dart FFI bridge communicating directly with `PhoneCamMediaSource.dll`.
...
- **COM Interfaces**: Implements `IMFMediaSource`, `IMFMediaStream`, `IMFSample`, `IMFMediaBuffer`.
- **Pixel Formats**: Native support for `NV12`, `RGB32`, `YUY2` across 720p, 1080p, 1440p, 4K at 30 and 60 FPS.
